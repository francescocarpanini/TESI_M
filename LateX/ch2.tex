...
\begin{itemize}
    ...
    This method ensures smooth and precise boundary representation, as shown in the figure below:
    \begin{figure}[H]
        \centering
    ...
    Using a thickness of 3 pixels, the anti-aliased polylines provide a visually smooth and accurate depiction of boundaries in the tensor.
