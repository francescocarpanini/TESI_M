...
The total Loss graph exhibits the anticipated behavior, as depicted in Figure ~\ref{fig:smooth-l1-total-loss} gradually decreasing as the number of iterations increases. 
\begin{figure}[H]
    \centering
